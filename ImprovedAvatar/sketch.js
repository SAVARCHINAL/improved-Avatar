...
function preload() {
  ...
  playerAvatar.addMovingAnimation( 'assets/avatar1.png', 'assets/avatar4.png');
  ...
  grabbables.push(new StaticSprite("Star", random(0,750), random(0,600),'assets/fullStar.png'));
  grabbables.push(new StaticSprite("Key", random(0,750), random(0,600), 'assets/key.png'));
  grabbables.push(new StaticSprite("Wheel", random(0,750), random(0,600),  'assets/wheel.png'));
  grabbables.push(new StaticSprite("phone", random(0,750), random(0,600),  'assets/phone.png'));
  grabbables.push(new StaticSprite("lotto", random(0,750), random(0,600),  'assets/lotto.png'));
  grabbables.push(new StaticSprite("snowglobe", random(0,750), random(0,600),  'assets/snowglobe.png'));
}
